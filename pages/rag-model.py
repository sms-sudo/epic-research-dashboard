...
st.set_page_config(layout="wide", page_title="RAG Research Assistant")
...
if generate_btn and research_query:
    ...
    st.code("PATIENT -> ENCOUNTER -> DIAGNOSIS -> READMISSION_LOG", language="sql")

else:
    st.light("Enter a research idea above to see the RAG model in action.")